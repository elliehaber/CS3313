...
void Initialize() {
    ...
    displayWindow = SDL_CreateWindow("Ellie Haber's Project 6- The Robot Escape", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 640, 480, SDL_WINDOW_OPENGL);
